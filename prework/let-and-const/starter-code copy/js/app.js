...
// because we try to console variable has local scope(declared in displayPics function) , we should either consol the variable inside the function or make the variable global by declare  it outside the any function
